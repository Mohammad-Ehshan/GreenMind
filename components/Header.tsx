...
// // we are using this to ignore typescript error as web3 component will give typescript error as they don't have typescript type available
// 'use client'
...
// import { Menu, Coins, Leaf, Search, Bell, User, ChevronDown, LogIn, LogOut, Circle } from "lucide-react"
...
// import { createUser, getUnreadNotifications, markNotifiationAsRead, getUserByEmail, getUserBalance } from "@/utils/db/actions"
...
//   return (
//     <header className="bg-[#ECFDF5] border-b border-gray-200 top-0 z-50">
...
//            <span className="font-bold text-base md:text-lg text-gray-800">GreenMindAi</span>
//           </Link>
//         </div>
//         {!isMobile && (
...
//           <Link href="/" className="flex items-center">
//            <Leaf className="h-6 w-6 md:h-8 md:w-8 text-green-500 mr-1 md:mr-2"/>
//            <span className="font-bold text-base md:text-lg text-gray-800">Swatch Bharat</span>
//           </Link>
//         </div>
//         {!isMobile && (
//           <div className="flex-1 max-w-xl mx-4">
