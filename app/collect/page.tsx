...
// //         toast.error("Failed to load user data and task.Please try again");
// //       } finally {
// //         setLoading(false);
// //       }
// //     };
...
// //       toast.error("Missing required information for verifiation");
// //       return;
// //     }
...
// //       // const prompt=`You are an expert in waste mangagement and recycling.Analyze this image and provide:
// //       // 1.Confimr if the waste type matches:${selectedTask.wasteType}
// //       // 2.Estimate if the quantity matches: ${selectedTask.amount}
// //       // 3.Your confidence level in this assessment (as a percentage)

// //       // Respond in JSON formate like this:
// //       // {
...
// //           toast.success(
// //             `Verification successsful! You earned ${earnedReward} tokens!`,
// //             {
// //               duration: 3000,
// //               position: "top-center",
// //             }
...
// //         } else {
// //           toast.error(
// //             `Verification failed. The collected waste does not match teh reported waste.`,
// //             {
// //               duration: 3000,
// //               position: "top-center",
// //             }
...
// //       }
// //     } catch (error) {
// //       console.error("Errro verifying waste:", error);
// //       setVerificationStatus("failure");
// //     }
// //   };
...
// //                     <MapPin className="w-5 h-5 mr-2 text-gray-50" />
// //                     {task.location}
// //                   </h2>
...
// //                       <div className="absolute left-0 to-fuchsia-50 mt-1 p-2 bg-gray-800 text-white text-xs rounded shadow-lg z-10">
// //                         {task.wasteType}
// //                       </div>
// //                     )}
// //                   </div>
...
// //                   </div>
// //                   <div className="flex items-center">
// //                     {/* <Calender className="w-4 h-4 mr-2 text-gray-500"/> */}
// //                     {task.date}
// //                   </div>
// //                 </div>
...
// //     completed: { color: "bg-green-100 text-green800", icon: CheckCircle },
...
// //       const prompt = `You are an expert in waste management and recycling. Analyze this image and provide:
// // 1. Confirm if garbage is present in this photo.
// // 2. Estimate the quantity present in this photo.
// // 3. Your confidence level in this assessment (as a percentage)

// // Respond in JSON format like this:
// // {
// //   "wasteTypeMatch": true/false,
// //   "quantityMatch": estimated quantity,
// //   "confidence": confidence level as a number between 0 and 1
// // }`;
...
//                 <p>Waste Present: {verificationResult.wasteTypeMatch ? 'Yes' : 'No'}</p>
//                 <p>Quantity Present: {verificationResult.quantityMatch ? 'Yes' : 'No'}</p>
...
export default function CollectPage() {
  ...
  return (
    <div className='min-h-screen w-full my-gradient'>
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      <h1 className="text-3xl flex justify-center items-center font-semibold mb-6 text-gray-800">Waste Collection Tasks</h1>
      ...
      {loading ? (
        ...
        <>
          <div className="space-y-4">
            {paginatedTasks.map(task => (
              <div key={task.id} className="bg-white p-4 rounded-xl hover:bg-green-400 shadow-sm border border-gray-200">
                <div className="flex justify-between items-center mb-2">
                  <h2 className="text-lg font-medium text-gray-800 flex items-center">
                    <MapPin className="w-5 h-5 mr-2 text-gray-500" />
                    {task.location}
