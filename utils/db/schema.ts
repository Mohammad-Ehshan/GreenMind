import { boolean, integer, jsonb, pgTable, PgUpdateBase, serial, text, timestamp, varchar } from "drizzle-orm/pg-core";
...
export const CollectedWastes=pgTable('collected_waste',{
  ...
  collectionDate: timestamp('collected_date').notNull(),
